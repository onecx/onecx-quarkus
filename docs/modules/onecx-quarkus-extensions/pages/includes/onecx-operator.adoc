...
a| [[onecx-operator_onecx-operator-sdk-metrics-enabled]] [.property-path]##link:#onecx-operator_onecx-operator-sdk-metrics-enabled[`onecx.operator.sdk.metrics.enabled`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++onecx.operator.sdk.metrics.enabled+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Flag to enable or disable SDK metrics default: metrics are disabled (false)


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++ONECX_OPERATOR_SDK_METRICS_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++ONECX_OPERATOR_SDK_METRICS_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
