...
a| [[onecx-parameters_onecx-parameters-token-header-param]] [.property-path]##link:#onecx-parameters_onecx-parameters-token-header-param[`+++onecx.parameters.token-header-param+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++onecx.parameters.token-header-param+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++ONECX_PARAMETERS_TOKEN_HEADER_PARAM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++ONECX_PARAMETERS_TOKEN_HEADER_PARAM+++`
endif::add-copy-button-to-env-var[]
--
|string
