...
class ImageRestControllerTest {
    ...
    void maxSizeConstraintCustomExceptionTest() {
        ...
        assertThat(exception.getDetail()).isEqualTo(
                "uploadImageCustomValidation.contentLength: OneCX Size constraint. Provider: static Key: notDefined Parameter: notDefined Message: error-message from openapi definition (100 Bytes - 1100000 Bytes)");
    }
    ...
    void maxSizeConstraintDefaultExceptionTest() {
        ...
        var exception = given()
                ...
                .extract().as(ProblemDetailResponseDTO.class);
        assertThat(exception.getDetail()).isEqualTo(
                "uploadImageDefaultValidation.contentLength: OneCX Size constraint. Provider: static Key: paramNull Parameter: paramNull Message: Size Constraint Violation (1 Bytes - 1000000 Bytes)");
    }
